...
function aprifb () {
	var ref = window.open('https://m.facebook.com/Colap-Nazionale-491372444293524/?ref=hl', '_system', 'location=no');
}

function apritw () {
	var ref = window.open('https://twitter.com/CoLAP_Nazionale', '_system', 'location=no');
}

function aprili () {
	var ref = window.open('https://www.linkedin.com/in/colap', '_system', 'location=no');
}
...
window.plugin.email.open({
	to:      "",
	subject: "Contatto",
	body:    "La Digital Bisiness Card IBA di 'CoLAP' e' disponibile al link http://www.interactivebusinessapp.it/download/colap",
	isHtml:  true
});
